function s = sintesisLPC(str)
   ...
   %-----------------------------------------------%
      ...
      %------------------------------------------------%
         ...
         nb_np = 11;     % Tamaño de la ventana de media móvil anticausal para el pitch
         
         ns_med_np = 5; % Tamaño de la ventana de mediana para el pitch
   ...
   %-----------------------------------------------%
         ...
         for indx_frame=1:n_frames_difonema
            ...
            %-----------------------------------------------------------%
               ...
               if(np>0)
                  ...
                  u_periodo = [1; zeros((np-1),1)];   % Vector de excitación en un único periodo
            ...
            s_frame = filter(1,coefs,u);  % Sintetización del frame actual
      ...
      ro = 15/16;                   % De-enfatización de la señal resultante para 
      pre_enfasis = [1 -ro];        %  eliminar el efecto de preenfasis realizado
      s = filter(1,pre_enfasis,s);  %  en la generación de cada frame.
